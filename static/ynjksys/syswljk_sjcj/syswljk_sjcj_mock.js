(function(global){
  ...
  function make(){var now=new Date(),results=[],logs=[],metrics={"D-001":[["温度","℃",23.4],["湿度","%RH",52.1]],"D-002":[["温度","℃",25.8],["湿度","%RH",68.2]],"D-003":[["温度","℃",7.3],["湿度","%RH",71.5]],"D-004":[["电压","V",231.6],["电流","A",48.2]],"D-005":[["门状态","",0]]};
