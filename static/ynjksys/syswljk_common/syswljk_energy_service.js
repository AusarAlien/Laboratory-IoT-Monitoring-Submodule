(function (global) {
  ...
  function mapDevice(r) {
    return {id:String(field(r,"FINSTID")||""),ip:String(field(r,"FINSTID")||""),code:String(field(r,"FINSTID")||""),name:String(field(r,"FINSTNAME")||""),dept:String(field(r,"FDEPTNO")||"未设置"),area:String(field(r,"FDEPTNO")||"未设置"),type:"设备能耗监测设备",socket:String(field(r,"FSSID")||"")};
  }
  function mapRecord(r) {
    return {rowNo:num(field(r,"FROWSEQ")),id:String(field(r,"FRECORDID")||""),sourceId:String(field(r,"FID")||""),deviceId:String(field(r,"FINSTID")||""),deviceIp:String(field(r,"FINSTID")||""),deviceName:String(field(r,"FINSTNAME")||""),dept:String(field(r,"FDEPTNO")||"未设置"),deviceType:"设备能耗监测设备",metricCode:String(field(r,"FMETRICCODE")||""),metricName:String(field(r,"FMETRICNAME")||""),value:num(field(r,"FVALUE")),unit:String(field(r,"FUNIT")||""),lower:null,upper:null,status:String(field(r,"FDATASTATUS")||"无效"),alarm:String(field(r,"FALARMDESC")||""),time:String(field(r,"FMONITORTIME")||""),socket:String(field(r,"FSSID")||""),raw:String(field(r,"FRAWDATA")||""),total:num(field(r,"FTOTALCOUNT"))||0};
  }
  ...
  function mapRealtime(r) { return {id:String(field(r,"FDEVICEID")||""),code:String(field(r,"FINSTID")||""),name:String(field(r,"FINSTNAME")||""),type:"设备能耗监测设备",area:String(field(r,"FDEPTNO")||"未设置"),status:String(field(r,"FUNIFIEDSTATUS")||"未知"),rawCode:String(field(r,"FRAWSTATUS")||""),rawName:String(field(r,"FRAWSTATUSNAME")||"未知"),description:String(field(r,"FSTATUSDESC")||""),lastTime:String(field(r,"FLASTTIME")||""),timeout:num(field(r,"FTIMEOUT"))||180,duration:String(field(r,"FDURATION")||"--")}; }
